...
public class Semester7th extends Student implements Result {
	
	private String sub1, sub2;
	private float mark1, mark2, grade1, grade2,credit1,credit2;
	
	public Semester7th(String name, int Usd, int reg) {
		super(reg,Usd,name);
	}
	...
	sub1="Introduction to Artifical Intelligences ";
	sub2="Compiler Designing";
	credit1=(float)2.0;
	credit2=(float)3.0;
	}
